...
class ClothesDetailsViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    
    @IBOutlet weak var nameLabel: UILabel!
    @IBOutlet weak var addressLabel: UILabel!
    @IBOutlet weak var clothesDetailsMapView: MKMapView!
    ...
    override func viewDidLoad() {
        ...
        clothesDetailsMapView.addAnnotation(annotation)
        locationManager.requestWhenInUseAuthorization()
        clothesDetailsMapView.showsUserLocation = true
        locationManager.delegate = self
        locationManager.startUpdatingLocation()
        clothesDetailsMapView.delegate = self
    }
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        clothesDetailsMapView.setRegion(region, animated: true)
    }
